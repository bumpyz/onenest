...
ReactDOM.createRoot(document.getElementById('root')).render(
  <DesignCanvas>
    ...
    <DCSection id="pair-conflict" title="04.3 · Conflict resolution — full screen" subtitle="The full-screen version of the inline conflict ribbon · two event cards with an X glyph between them, 45min overlap bar, 3 ranked suggestions (BEST PICK badge, effort estimate), manual options below, sticky 'Apply' CTA showing the selected outcome.">
    ...
    <DCSection id="pair-handoff" title="06.3 · Custody — hand-off day (Oliver → Casey)" subtitle="What tapping a hand-off opens · countdown, From → To with avatars and the kid in between, before-pickup checklist, the privacy-fenced view of what Casey will actually see.">
    ...
    <DCSection id="pair-custody" title="06.4 · Custody — schedule viewer (reference, no Pattern button)" subtitle="Original Custody Schedule before the Pattern button was added. Kept as before/after reference — superseded by 06.1.">
    ...
    <DCSection id="pair-child-detail" title="07.2 · Child detail — Soph" subtitle="Child profile · where she is this week (custody mini-bar), upcoming events, lists tagged for her, contacts that belong to her (piano teacher, doctor), allergy notes.">
    ...
    <DCSection id="pair-remove" title="07.3 · Remove caregiver — bottom sheet" subtitle="Parent's view from Family Hub → tap Nina → this sheet. Hero with her avatar + role + tenure, current access summary, alert-tinted 'happens immediately' consequences, dashed-border 'what stays' (completed tasks + history attribution), destructive Remove + Cancel.">
    ...
    <DCSection id="pair-family-hub" title="07.4 · Family Hub — reference (Manage with Contacts + Custody)" subtitle="Original Family Hub before Custody was promoted and Contacts became a top-level tab. Kept as before/after reference — superseded by 07.1.">
