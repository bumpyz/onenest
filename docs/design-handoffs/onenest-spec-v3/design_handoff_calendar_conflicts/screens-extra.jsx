          ...
          <div style={{ padding: '14px 24px 16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
              ...
              <div style={{
                ...
                padding: '3px 9px 3px 9px', borderRadius: 999,
                ...
                CONFLICT
                <svg width="5" height="8" viewBox="0 0 8 14" fill="none" style={{ marginLeft: 1 }}>
                  <path d="M1 1l6 6-6 6" stroke={C.warn} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            </div>
          </div>
    ...
    <IOSDevice dark={dark}>
      <div style={{ position: 'absolute', inset: 0, background: C.bg, fontFamily: C.fontSans, color: C.ink, overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          {CIcon.plus(C.onAccent)}
          <span style={{ color: C.onAccent, fontSize: 13, fontWeight: 600, letterSpacing: -0.2 }}>New contact</span>
        </div>
