  ...
  return (
    <IOSDevice dark={dark}>
      <div style={{ position: 'absolute', inset: 0, background: C.bg, fontFamily: C.fontSans, color: C.ink, overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, paddingTop: 54, paddingBottom: 80 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {/* + New event — accent action, scoped to selected day */}
              <div style={{
                flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center',
                gap: 5, padding: '4px 8px',
              }}>
                <svg width="11" height="11" viewBox="0 0 14 14" fill="none">
                  <path d="M7 2v10M2 7h10" stroke={C.accent} strokeWidth="1.6" strokeLinecap="round"/>
                </svg>
                <span style={{
              ...
              {/* Divider */}
              <div style={{ width: 0.5, alignSelf: 'stretch', background: C.hair }} />
              {/* Open day view */}
              <div style={{
                flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center',
                gap: 5, padding: '4px 8px',
                ...
                <span style={{
                  fontFamily: C.fontMono, fontSize: 11, color: C.inkSec, fontWeight: 600,
                  letterSpacing: 0.3, textTransform: 'uppercase',
                }}>Open day view</span>
                <svg width="8" height="10" viewBox="0 0 10 10" fill="none">
                  <path d="M3 1.5l3.5 3.5L3 8.5" stroke={C.inkSec} strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            </div>
          </div>
        ...
        {/* No FAB on Month view — '+ New event' lives inside the selected-day
            preview card, scoped to the selected day. This is the canonical
            exception to the FAB-on-every-tab pattern. */}
